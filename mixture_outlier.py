...
def margin_classifiers_perf(d=1000,n=100,approx_tau=1, SNR=10, n_test=1e4, s=None, random_flip_prob=0, l1=True, l2=False, mixture=False, outlier_strength=100):
    ...
    if s is None:
        ...
        if mixture:
            xs, ys, x_seq_test, y_seq_test, z1s, z2s = create_data_mixture(d,n1,n2,n_test, s=s, random_flip_prob=random_flip_prob, SNR=SNR, outlier_strenght=outlier_strength)
...
def aspect_ratio_l1(d, n, change_d, n_runs=10, sigma=0, s=1, l1=True, l2=False, SNR=5, mixture=False, outlier_strength=100):
    ...
    for run in range(runs):
        ...
        for t in approx_ar:
            ...
            err_mm, errs_avm_poly, err_train_mm, errs_train_avm_poly, err_mm_l1, errs_avm_poly_l1, err_train_mm_l1, errs_train_avm_poly_l1,  wmm_l2, w_l2, wmm_l1, w_l1 = margin_classifiers_perf(d=d,n=n,approx_tau=1, SNR=SNR, n_test=1e4, s=s, l1=True, l2=l2, random_flip_prob=sigma, mixture=mixture, outlier_strength=outlier_strength)
    ...
    if change_d:
        plt.savefig("figures_mixture_outlier/sparse_model_n"+ str(n) + "_s"+ str(s)+"_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
    else:
        plt.savefig("figures_mixture_outlier/sparse_model_d"+ str(d)+ "_s"+ str(s)+"_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
    ...
    if change_d:
        plt.savefig("figures_mixture_outlier/train_sparse_model_n"+ str(n) + "_s"+ str(s)+"_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
    else:
        plt.savefig("figures_mixture_outlier/train_sparse_model_d"+ str(d)+ "_s"+ str(s)+"_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
    ...
    if change_d:
        plt.savefig("figures_mixture_outlier/bias_variance_n"+ str(n)+ "_s"+ str(s) + "_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
    else:
        plt.savefig("figures_mixture_outlier/bias_variance_d"+ str(d)+ "_s"+ str(s) + "_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
    ...
    if change_d:
        plt.savefig("figures_mixture_outlier/est_err_n"+ str(n)+ "_s"+ str(s) + "_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
    else:
        plt.savefig("figures_mixture_outlier/est_err_d"+ str(d)+ "_s"+ str(s) + "_sigma"+str(sigma)+"_outlier"+str(outlier_strength)+"_SNR"+str(SNR)+".pdf")
