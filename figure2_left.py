# -*- coding: utf-8 -*-
"""Copy of figure2_left.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1a8kqhyC8QD5c1WoG69ttB_PfrRgV2_NP
...
def run_fig_2(n_train=100, n_test=int(1e4),  n_features=20, n_informative=2, n_redundant=2, n_repeated=0, n_classes=2, n_clusters_per_class=2, class_sep=1.0, n_runs=5):
  ...
  for run in range(runs):
    ...
    for t in approx_taus:
      ...
      xs, ys, x_seq_test, y_seq_test, z1s, z2s = create_data(n1, n2, int(n_test/2), int(n_test/2),  n_features=p, n_informative=n_informative, n_redundant=n_redundant, n_repeated=n_repeated, n_classes=n_classes, n_clusters_per_class=n_clusters_per_class, class_sep=class_sep)
...
def fig2(n_train=100, n_test=int(1e4),  n_features=20, n_informative=2, n_redundant=2, n_repeated=0, n_classes=2, n_clusters_per_class=2, class_sep=1.0, n_runs=10):
  data = run_fig_2(n_train=n_train, n_test=n_test,  n_features=n_features, n_informative=n_informative, n_redundant=n_redundant, n_repeated=n_repeated, n_classes=n_classes, n_clusters_per_class=n_clusters_per_class, class_sep=class_sep, n_runs=n_runs)
